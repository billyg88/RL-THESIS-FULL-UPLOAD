...
agent = 'PongNoFrameskip-v4_diff_curriculum-best_7.dat'  # variable and easy to change 
...
state = torch.load('models/DoubleDQN/'+agent, map_location=lambda stg, _: stg)   #Source directory also changes for each agent type
net.load_state_dict(state)


writer = SummaryWriter(log_dir = "runs/Paper runs/Test runs/" +'DoubleDQN_ '+ agent +" -Diff " + str(difficulty))
