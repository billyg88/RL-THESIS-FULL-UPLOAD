...
def make_train_env(env_name, difficulty, save_every_x_games = 20, name_of_game = 'NAME THE GAME!!!', net_type ='DQN', stacked_frames = 2):
    ...
    env = PyTorchFrame(env) # Converts the frames into Pytorch format by simply reshaping the Matrix always needed THE ORIGINAL TF VERSION IS WxHxCh to Pytorch which is CHNANELxWidthxHeight
